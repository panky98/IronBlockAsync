...
namespace IronBlock.Tests
{
  ...
  {
    [TestMethod]
    public async Task Test_Text_Length()
    {
      const string xml = @"
<xml>
...
";
    ...
    [TestMethod]
    public async Task Test_Text_IsEmpty()
    {
      const string xml = @"
<xml>
...
";
      var output = (bool) await new Parser()
        .AddStandardBlocks()
        .Parse(xml)
        .Evaluate();
    ...
    [TestMethod]
    public async Task Test_Text_Trim()
    {
      const string xml = @"
<xml>
...
";
    ...
    [TestMethod]
    public async Task Test_Text_ToCase()
    {
      const string xml = @"
<xml>
...
";
    ...
    [TestMethod]
    public async Task Test_IndexOf()
    {
      const string xml = @"
<xml>
