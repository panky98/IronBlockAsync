...
namespace IronBlock.Tests
{
  ...
  public class ListsTests
  {
    ...
    [TestMethod]
    public async Task Test_List_Create_With()
    {
      const string xml = @"
...
";
    ...
    [TestMethod]
    public async Task Test_List_Split()
    {
      const string xml = @"
<xml xmlns=""http://www.w3.org/1999/xhtml"">
...
";
    ...
    [TestMethod]
    public async Task Test_Lists_Join()
    {
      const string xml = @"
<xml xmlns=""http://www.w3.org/1999/xhtml"">
  <block type=""lists_split"">
    ...
    [TestMethod]
    public async Task Test_Lists_Length()
    {
      const string xml = @"
<xml xmlns=""http://www.w3.org/1999/xhtml"">
...
";
    ...
    [TestMethod]
    public async Task Test_Lists_Repeat()
    {
      const string xml = @"
<xml xmlns=""http://www.w3.org/1999/xhtml"">
...
";
    ...
    [TestMethod]
    public async Task Test_Lists_IsEmpty()
    {
      const string xml = @"
<xml xmlns=""http://www.w3.org/1999/xhtml"">
...
";
    ...
    [TestMethod]
    public async Task Test_Lists_IndexOf()
    {
      const string xml = @"
<xml xmlns=""http://www.w3.org/1999/xhtml"">
  <variables></variables>
...
";
    ...
    [TestMethod]
    public async Task Test_Lists_GetIndex()
    {
      const string xml = @"
<xml xmlns=""http://www.w3.org/1999/xhtml"">
