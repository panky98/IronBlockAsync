...
namespace IronBlock.Blocks.Math
{
  public class MathNumberProperty : IBlock
  {
    public override async Task<object> Evaluate(Context context)
    {
      ...
      var number = (double)(await this.Values.Evaluate("NUMBER_TO_CHECK", context));
      ...
      switch (op)
      {
        ...
        case "DIVISIBLE_BY": return 0 == number % (double)(await this.Values.Evaluate("DIVISOR", context));
