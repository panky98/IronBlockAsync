...
namespace IronBlock.Blocks.Math
{
  public class MathConstrain : IBlock
  {
    ...
    {
      var value = (double)(await this.Values.Evaluate("VALUE", context));
      var low = (double)(await this.Values.Evaluate("LOW", context));
      var high = (double)(await this.Values.Evaluate("HIGH", context));
