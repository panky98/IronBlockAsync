...
namespace IronBlock.Blocks.Controls
{
  public class ControlsFor : IBlock
  {
    public override async Task<object> Evaluate(Context context)
    {
      ...
      var fromValue = (double)(await this.Values.Evaluate("FROM", context));
      var toValue = (double)(await this.Values.Evaluate("TO", context));
      var byValue = (double)(await this.Values.Evaluate("BY", context));
